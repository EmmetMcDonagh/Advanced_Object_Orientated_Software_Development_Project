...
/**
 * The console colour class prints colour in the console, the ANSI escape codes
 * are used to use colour in the output. 
 */
...
public class ConsoleColour {
	...
	// This will create a black background and make the text previous color Unless
	// color black, then it will make it white
